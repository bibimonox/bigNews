...
public class ConnectionUtil {
    ...
    /**
     * Create a private constructor because no one should ever create a {@link ConnectionUtil} object.
    ...
    private static List<News> extractFeatureFromJson(String newsJSON) {
        ...
        try {
            ...
            for (int i = 0; i < newsArray.length(); i++) {
                ...
                news.add(new News( currentTitle, currentNewsAuthor, currentCategory, currentDateTime, currentUrl));
            }
